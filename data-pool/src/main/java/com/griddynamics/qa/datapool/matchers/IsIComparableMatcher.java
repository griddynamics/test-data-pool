...
/**
 * Compares date type fields (EQUAL case). Supported date types:
 * java.util.Date
 * java.util.Calendar
 ...
 * Created: 2016-07-05.
 */
class IsIComparableMatcher implements IComparableMatcher {
    @Override
    public Predicate<IDataType> getMatcher(String propName, Object value) {
        return buildMatcher(propName, value, RelationSign.EQUAL);
    }
}
